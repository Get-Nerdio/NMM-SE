...
4. Downloads and Installs March2024 version of WebRTC component
...
#To roll-back to the latest, delete the second $dlink2


$dlink2 = "https://aka.ms/msrdcwebrtcsvc/msi"
$dlink2 = "https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RW1jLHP"
