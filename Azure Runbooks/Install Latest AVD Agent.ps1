...
and installs the most recent RDAgent and bootloader, and adds the host back to the host pool. 
Because this process requires removing and re-adding the host to the host pool, this can take several 
