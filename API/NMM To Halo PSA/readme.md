...
Credits to Mikey O'Toole (also known as [Homotechsual](https://homotechsual.dev/)), who developed the [HaloPSA PowerShell Module](https://github.com/homotechsual/HaloAPI/tree/main). This module significantly simplifies interactions with the Halo PSA API, facilitating the core functionalities of our script.
